...
export class VoiceController {
  ...
  async demoPreview(@Body() body: { clip?: string }) {
    ...
    const scripts: Record<string, string> = {
      welcome:
        'হ্যালো সাকিব, আপনি ঘরেবাজারে এক কেজি মধু অর্ডার করেছিলেন। যার মূল্য এক হাজার দুইশ টাকা। আপনার অর্ডারটি যদি কনফার্ম হয়, তাহলে এক চাপুন। বাতিল করতে দুই চাপুন।',
      confirm:
