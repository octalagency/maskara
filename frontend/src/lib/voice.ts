...
export const VOICE_OPTIONS = [
  ...
  },
  {
    ...
    provider: 'Google Chirp3',
    description: 'প্রাকৃতিক নারী — পরিষ্কার উচ্চারণ',
    recommended: false,
    requiresGoogleTts: true,
  },
  {
    ...
    gender: 'female' as const,
    provider: 'Google Chirp3',
    description: 'প্রফেশনাল নারী — উষ্ণ আবেগ ও কল-সেন্টার টোন (প্রস্তাবিত নারী)',
    recommended: true,
    requiresGoogleTts: true,
  },
  {
    ...
    gender: 'female' as const,
    provider: 'Google Chirp3',
    description: 'স্পষ্ট নারী — স্পষ্ট নির্দেশনা ও বোধগম্যতা',
    recommended: false,
    requiresGoogleTts: true,
  },
  {
    ...
    gender: 'female' as const,
    provider: 'Google Chirp3',
    description: 'নরম নারী — মৃদু ও বন্ধুত্বপূর্ণ',
    recommended: false,
    requiresGoogleTts: true,
  },
  {
