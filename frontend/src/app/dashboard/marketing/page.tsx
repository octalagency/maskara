...
import { api, MarketingSettings, MarketingPixel } from '@/lib/api';
import {
  Check,
  Copy,
  ExternalLink,
...
export default function MarketingPage() {
  ...
  async function save() {
    ...
    try {
      ...
      const res = await api.updateMarketing({
  ...
  return (
    <DashboardLayout>
      <div className="mx-auto max-w-3xl space-y-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">
              Sitemap, Product Feed ও Pixel + Conversion API — ShopIn-এর মতো সেটআপ
            </p>
          </div>
        </div>
        ...
        <div className="card space-y-4">
          <div>
            ...
            <p className="mt-1 text-xs text-slate-500">
              যে ডোমেইনে আপনার শপ চলে (যেমন https://filo.bd) — এখান থেকে sitemap ও
              feed URL তৈরি হয়
            </p>
          </div>
          <input
        ...
        <div className="card space-y-5">
          <div>
            <h3 className="font-semibold text-slate-900">Facebook Product Feed</h3>
            <p className="mt-1 text-xs text-slate-500">
          ...
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              <ol className="mt-2 list-decimal space-y-1 pl-5 text-xs text-slate-600">
                <li>Meta Business Suite → Events Manager খুলুন</li>
                <li>Pixel তৈরি করুন / বিদ্যমান Pixel বেছে নিন</li>
                <li>Pixel ID এখানে পেস্ট করুন</li>
                <li>
                  Settings → Conversions API থেকে Access Token জেনারেট করে দিন
                </li>
                <li>টেস্টের সময় Test Event Code ব্যবহার করুন</li>
              </ol>
            </div>
            <a
              href={data?.eventsManagerUrl || 'https://business.facebook.com/events_manager2'}
              target="_blank"
              rel="noreferrer"
