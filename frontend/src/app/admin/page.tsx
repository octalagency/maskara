...
export default function AdminDashboardPage() {
  ...
  const controls = [
    ...
    { href: '/admin/payments', label: 'পেমেন্ট গেটওয়ে', desc: 'bKash portal + Payment SIM', icon: Banknote, color: 'bg-pink-50 text-pink-700' },
    ...
    <div className="space-y-8">
      ...
      <div className="card">
        ...
        <div className="mt-4 flex flex-wrap gap-3 text-sm">
          ...
          <span className="badge-info inline-flex items-center gap-1"><Globe className="h-3 w-3" /> {status.merchants?.storesConnected ?? status.merchants?.wooConnected ?? 0} store connected</span>
        </div>
