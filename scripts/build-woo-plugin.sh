...
manifest = {
    ...
    "tested": "6.7",
    "requires_php": "7.4",
    "description": "AI voice order verification for WooCommerce. Confirm sets Completed + Pathao auto-deploy. Only customer cancel (pressed 2) sets Cancelled — missed calls no longer auto-cancel.",
    "changelog": f"<h4>{version}</h4><ul><li>Stop auto-cancelling Woo orders on missed / no-answer calls — only DTMF 2 cancels</li></ul><h4>1.5.15</h4><ul><li>WooCommerce HPOS + Cart/Checkout Blocks compatibility declared (incompatible banner fix)</li></ul><h4>1.5.14</h4><ul><li>Collected Amount + Delivery Charges KPI ঠিক</li><li>Courier dashboard UI polish</li></ul><h4>1.5.13</h4><ul><li>Website Completed → Maskara Manual Complete + stop calls</li></ul>",
}
...
for legacy in 1.1.0 1.2.0 1.4.0 1.5.0 1.5.1 1.5.2 1.5.3 1.5.4 1.5.5 1.5.6 1.5.7 1.5.8 1.5.9 1.5.10 1.5.11 1.5.12 1.5.13 1.5.14 1.5.15; do
